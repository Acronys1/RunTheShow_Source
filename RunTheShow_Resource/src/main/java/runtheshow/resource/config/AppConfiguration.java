 ...
 * @author maxim
 */
@EnableJpaRepositories(basePackages = {"runtheshow.resource.entities", "runtheshow.resource.repository"})
@EnableAutoConfiguration
@ComponentScan(basePackages = {"runtheshow.resource"})
@EntityScan(basePackages = {"runtheshow.resource.entities", "runtheshow.resource.repository"})
