angular
        .module('app', ['ngRoute', 'auth', 'home', 'users', 'navigation', 'datatables', 'demo', 'event', 'userprofile', 'signup', 'artist_presentation', 'xeditable', 'disableAll', 'file', 'calendarDemoApp', 'myEvent'])
        .config(
